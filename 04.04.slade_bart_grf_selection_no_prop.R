...
plot_ATE_dev <- hte_plot(ATE_validation_dev[["effects"]], "hba1c_diff.pred", "obs", "lci", "uci", "Development")
...
plot_ATE_val <- hte_plot(ATE_validation_val[["effects"]], "hba1c_diff.pred", "obs", "lci", "uci", "Validation")
