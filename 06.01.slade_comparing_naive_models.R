...
if (class(try(
  ...
  ATE_weighting_validation_dev_comp_routine_no_prop <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_comp_routine_no_prop <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_comp_routine_prop <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_comp_routine_prop <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_incomp_routine_no_prop <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_incomp_routine_no_prop <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_incomp_no_prop <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_incomp_no_prop <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_incomp_no_prop_var_select <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_incomp_no_prop_var_select <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_incomp_prop <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_incomp_prop <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_incomp_prop_var_select_1 <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_incomp_prop_var_select_1 <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_dev_incomp_prop_var_select <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final")
...
if (class(try(
  ...
  ATE_weighting_validation_val_incomp_prop_var_select <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final")
