...
## make directory for outputs
dir.create(paste0(output_path, "/Final_model/cvd_new"))


## make directory for outputs
dir.create(paste0(output_path, "/Final_model/cvd_new/Assessment"))
...
if (class(try(
  ...
  bart_model <- readRDS(paste0(output_path, "/Final_model/cvd_new/bart_model.rds"))
  ...
  saveRDS(bart_model, paste0(output_path, "/Final_model/cvd_new/bart_model.rds"))
...
if (class(try(
  ...
  bart_var_selection <- readRDS(paste0(output_path, "/Final_model/cvd_new/bart_var_selection.rds"))
  ...
  saveRDS(bart_var_selection, paste0(output_path, "/Final_model/cvd_new/bart_var_selection.rds"))
...
if (class(try(
  ...
  bart_var_selection_cv <- readRDS(paste0(output_path, "/Final_model/cvd_new/bart_var_selection_cv.rds"))
  ...
  saveRDS(bart_var_selection_cv, paste0(output_path, "/Final_model/cvd_new/bart_var_selection_cv.rds"))
...
# 
# # egfr_ckdepi <- 0.26255757
# # agetx <- 0.12894837
# # score.excl.mi <- 0.10071862
# # malesex1 <- 0.07412198
# # prealt <- 0.06434756
# # prehba1cmmol <- 0.06049219
# # hba1cmonth <- 0.05555050
# # prehdl <- 0.04654345
# # preplatelets <- 0.04240795
# # prebil <- 0.02987910
# # t2dmduration <- 0.02186311
# # prealb <- 0.02085700
# # presys <- 0.02073518
# # prebmi <- 0.01920528
# # preast <- 0.01523449
# # --- threshold at 0.01
# # ncurrtx1 <- 0.004495356
# 
...
if (class(try(
  ...
  saveRDS(bart_model_final, paste0(output_path, "/Final_model/cvd_new/bart_model_final.rds"))
...
if (class(try(
  ...
  posteriors_dev <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/posteriors_dev.rds"))
  ...
  saveRDS(posteriors_dev, paste0(output_path, "/Final_model/cvd_new/Assessment/posteriors_dev.rds"))
...
if (class(try(
  ...
  cred_pred_dev <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/cred_pred_dev.rds"))
  
  , silent = TRUE)) == "try-error") {
  
  cred_pred_dev <- calc_resid(data_dev, posteriors_dev)
  
  saveRDS(cred_pred_dev, paste0(output_path, "/Final_model/cvd_new/Assessment/cred_pred_dev.rds"))
...
if (class(try(
  ...
  posteriors_val <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/posteriors_val.rds"))
  ...
  saveRDS(posteriors_val, paste0(output_path, "/Final_model/cvd_new/Assessment/posteriors_val.rds"))
...
if (class(try(
  ...
  cred_pred_val <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/cred_pred_val.rds"))
  
  , silent = TRUE)) == "try-error") {
  
  cred_pred_val <- calc_resid(data_val, posteriors_val)
  
  saveRDS(cred_pred_val, paste0(output_path, "/Final_model/cvd_new/Assessment/cred_pred_val.rds"))
...
if (class(try(
  ...
  assessment <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/assessment.rds"))
  ...
  saveRDS(assessment, paste0(output_path, "/Final_model/cvd_new/Assessment/assessment.rds"))
...
if (class(try(
  ...
  saveRDS(effects_summary_dev, paste0(output_path, "/Final_model/cvd_new/Assessment/effects_summary_dev.rds"))
...
if (class(try(
  ...
  saveRDS(effects_summary_val, paste0(output_path, "/Final_model/cvd_new/Assessment/effects_summary_val.rds"))
...
if (class(try(
  ...
  ATE_validation_dev <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/ATE_validation_dev.rds"))
  
  , silent = TRUE)) == "try-error") {
  
  ATE_validation_dev <- calc_ATE_validation(predicted_observed_dev)
  
  saveRDS(ATE_validation_dev, paste0(output_path, "/Final_model/cvd_new/Assessment/ATE_validation_dev.rds"))
...
if (class(try(
  ...
  ATE_validation_val <- readRDS(paste0(output_path, "/Final_model/cvd_new/Assessment/ATE_validation_val.rds"))
  
  , silent = TRUE)) == "try-error") {
  
  ATE_validation_val <- calc_ATE_validation(predicted_observed_val)
  
  saveRDS(ATE_validation_val, paste0(output_path, "/Final_model/cvd_new/Assessment/ATE_validation_val.rds"))
