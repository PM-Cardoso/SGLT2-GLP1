...
## make directory for outputs
dir.create(paste0(output_path, "/Final_model/model_1"))

## make directory for outputs
dir.create(paste0(output_path, "/Final_model/model_1/Assessment"))
...
if (class(try(
  ...
  prop_model <- readRDS(paste0(output_path, "/Final_model/model_1/prop_model.rds"))
  ...
  saveRDS(prop_model, paste0(output_path, "/Final_model/model_1/prop_model.rds"))
}
...
if (class(try(
  ...
  prop_var_selection <- readRDS(paste0(output_path, "/Final_model/model_1/prop_var_selection.rds"))
  ...
  # [4] "drugline_5"             "drugline_2"             "prehba1cmmol"
  # [7] "egfr_ckdepi"            "ncurrtx_3"              "drugline_3"
  # [10] "drugline_4"             "Category_Active smoker" "Category_Non-smoker"
  
  saveRDS(prop_var_selection, paste0(output_path, "/Final_model/model_1/prop_var_selection.rds"))
...
if (class(try(
  ...
  prop_model_final <- readRDS(paste0(output_path, "/Final_model/model_1/prop_model_final.rds"))
  ...
  prop_model_final <- bartMachine::bartMachine(X = dataset.dev %>%
                                               ...
                                               serialize = TRUE,
                                               seed = 123)
  saveRDS(prop_model_final, paste0(output_path, "/Final_model/model_1/prop_model_final.rds"))
...
if (class(try(
  ...
  bart_model <- readRDS(paste0(output_path, "/Final_model/model_1/bart_model.rds"))
  ...
  saveRDS(bart_model, paste0(output_path, "/Final_model/model_1/bart_model.rds"))
...
if (class(try(
  ...
  bart_var_selection <- readRDS(paste0(output_path, "/Final_model/model_1/bart_var_selection.rds"))
  ...
  saveRDS(bart_var_selection, paste0(output_path, "/Final_model/model_1/bart_var_selection.rds"))
...
if (class(try(
  ...
  bart_var_selection_cv <- readRDS(paste0(output_path, "/Final_model/model_1/bart_var_selection_cv.rds"))
  ...
  saveRDS(bart_var_selection_cv, paste0(output_path, "/Final_model/model_1/bart_var_selection_cv.rds"))
...
if (class(try(
  ...
  bart_model_final <- readRDS(paste0(output_path, "/Final_model/model_1/bart_model_final.rds"))
  ...
  saveRDS(bart_model_final, paste0(output_path, "/Final_model/model_1/bart_model_final.rds"))
...
data_dev <- dataset.dev %>%
  select(
    patid, pateddrug, posthba1c_final, 
...
if (class(try(
  ...
  posteriors_dev <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/posteriors_dev.rds"))
  ...
  saveRDS(posteriors_dev, paste0(output_path, "/Final_model/model_1/Assessment/posteriors_dev.rds"))
...
if (class(try(
  ...
  cred_pred_dev <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/cred_pred_dev.rds"))

  , silent = TRUE)) == "try-error") {

  cred_pred_dev <- calc_resid(data_dev, posteriors_dev, "posthba1c_final")

  saveRDS(cred_pred_dev, paste0(output_path, "/Final_model/model_1/Assessment/cred_pred_dev.rds"))
...
if (class(try(
  ...
  posteriors_val <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/posteriors_val.rds"))
  ...
  saveRDS(posteriors_val, paste0(output_path, "/Final_model/model_1/Assessment/posteriors_val.rds"))
...
if (class(try(
  ...
  cred_pred_val <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/cred_pred_val.rds"))

  , silent = TRUE)) == "try-error") {

  cred_pred_val <- calc_resid(data_val, posteriors_val, "posthba1c_final")

  saveRDS(cred_pred_val, paste0(output_path, "/Final_model/model_1/Assessment/cred_pred_val.rds"))
...
if (class(try(
  ...
  assessment <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/assessment.rds"))
  ...
  saveRDS(assessment, paste0(output_path, "/Final_model/model_1/Assessment/assessment.rds"))
...
if (class(try(
  ...
  effects_summary_dev <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/effects_summary_dev.rds"))

  , silent = TRUE)) == "try-error") {

  effects_summary_dev <- calc_effect_summary(bart_model_final, data_dev)

  saveRDS(effects_summary_dev, paste0(output_path, "/Final_model/model_1/Assessment/effects_summary_dev.rds"))
...
if (class(try(
  ...
  effects_summary_val <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/effects_summary_val.rds"))

  , silent = TRUE)) == "try-error") {

  effects_summary_val <- calc_effect_summary(bart_model_final, data_val)

  saveRDS(effects_summary_val, paste0(output_path, "/Final_model/model_1/Assessment/effects_summary_val.rds"))
...
effects_summary_dev_male <- effects_summary_dev %>%
  cbind(malesex = dataset.dev$malesex) %>%
  filter(malesex == 1)
...
if (class(try(
  ...
  ATE_validation_dev <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/ATE_validation_dev.rds"))

  , silent = TRUE)) == "try-error") {

  ATE_validation_dev <- calc_ATE_validation(predicted_observed_dev, "posthba1c_final", prop_model_dev)

  saveRDS(ATE_validation_dev, paste0(output_path, "/Final_model/model_1/Assessment/ATE_validation_dev.rds"))
...
if (class(try(
  ...
  ATE_validation_val <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/ATE_validation_val.rds"))

  , silent = TRUE)) == "try-error") {

  ATE_validation_val <- calc_ATE_validation(predicted_observed_val, "posthba1c_final", prop_model_val)

  saveRDS(ATE_validation_val, paste0(output_path, "/Final_model/model_1/Assessment/ATE_validation_val.rds"))
...
if (class(try(
  ...
  ATE_matching_validation_dev <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/ATE_matching_validation_dev.rds"))

  , silent = TRUE)) == "try-error") {

  ATE_matching_validation_dev <- calc_ATE_validation_prop_matching(predicted_observed_dev, "posthba1c_final", prop_model_dev)

  saveRDS(ATE_matching_validation_dev, paste0(output_path, "/Final_model/model_1/Assessment/ATE_matching_validation_dev.rds"))
...
if (class(try(
  ...
  ATE_matching_validation_val <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/ATE_matching_validation_val.rds"))

  , silent = TRUE)) == "try-error") {

  ATE_matching_validation_val <- calc_ATE_validation_prop_matching(predicted_observed_val, "posthba1c_final", prop_model_val)

  saveRDS(ATE_matching_validation_val, paste0(output_path, "/Final_model/model_1/Assessment/ATE_matching_validation_val.rds"))
...
if (class(try(
  ...
  ATE_weighting_validation_dev <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/ATE_weighting_validation_dev.rds"))
  ...
  saveRDS(ATE_weighting_validation_dev, paste0(output_path, "/Final_model/model_1/Assessment/ATE_weighting_validation_dev.rds"))
...
if (class(try(
  ...
  ATE_weighting_validation_val <- readRDS(paste0(output_path, "/Final_model/model_1/Assessment/ATE_weighting_validation_val.rds"))
  ...
  saveRDS(ATE_weighting_validation_val, paste0(output_path, "/Final_model/model_1/Assessment/ATE_weighting_validation_val.rds"))
...
pdf(file = "Plots/4.1.model1_partial_dependence.pdf")
